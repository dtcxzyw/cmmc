...
/**
 ** \file build/generated/location.hh
...
namespace yy {
    ...
    public:
        ...
        explicit location(std::string* f, counter_type l = 1, counter_type c = 1) : begin(f, l, c), end(f, l, c) {}
...
#endif  // !YY_YY_BUILD_GENERATED_LOCATION_HH_INCLUDED
