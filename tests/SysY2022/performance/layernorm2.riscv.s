...
pcrel1175:
	...
	sd s8, 24(sp)
	addi s8, s7, %pcrel_lo(pcrel1175)
	sd s6, 32(sp)
	addi s6, a0, %pcrel_lo(pcrel1174)
	sd s1, 40(sp)
	li a0, 125
	sd s5, 48(sp)
	slli s1, a0, 5
	addi s5, a1, %pcrel_lo(pcrel1173)
	sd s0, 56(sp)
	li s0, 1000
	sd s9, 64(sp)
	mv s9, s4
