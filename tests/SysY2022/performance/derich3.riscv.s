...
pcrel702:
	...
	addi s0, a1, %pcrel_lo(pcrel702)
pcrel703:
	auipc a1, %pcrel_hi(my_y1)
	addi a0, a1, %pcrel_lo(pcrel703)
	addi a1, a2, %pcrel_lo(pcrel701)
	mv a2, zero
	li a3, 512
	bge zero, a3, label94
	j label93
