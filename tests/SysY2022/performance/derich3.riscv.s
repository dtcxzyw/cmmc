...
pcrel5215:
	...
	addi s0, a0, %pcrel_lo(pcrel5215)
pcrel5216:
	auipc a0, %pcrel_hi(my_y1)
	addi a0, a0, %pcrel_lo(pcrel5216)
pcrel5217:
	auipc a1, %pcrel_hi(my_y2)
	addi a1, a1, %pcrel_lo(pcrel5217)
	mv a2, zero
	li a3, 512
