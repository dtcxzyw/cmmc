...
pcrel719:
	...
	addi s0, a1, %pcrel_lo(pcrel719)
pcrel720:
	auipc a1, %pcrel_hi(my_y1)
	addi a0, a1, %pcrel_lo(pcrel720)
	addi a1, a2, %pcrel_lo(pcrel718)
	mv a2, zero
	li a3, 512
	blt zero, a3, label4
	li a3, 270
