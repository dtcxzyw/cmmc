...
pcrel690:
	...
	addi s0, a1, %pcrel_lo(pcrel690)
pcrel691:
	auipc a1, %pcrel_hi(my_y1)
	addi a0, a1, %pcrel_lo(pcrel691)
	addi a1, a2, %pcrel_lo(pcrel689)
	mv a2, zero
	li a3, 512
	bge zero, a3, label94
	j label93
