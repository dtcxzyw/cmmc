...
pcrel2180:
	...
	addi s0, a1, %pcrel_lo(pcrel2180)
pcrel2181:
	auipc a1, %pcrel_hi(my_y1)
	addi a0, a1, %pcrel_lo(pcrel2181)
	addi a1, a2, %pcrel_lo(pcrel2179)
	mv a2, zero
	li a3, 512
	blt zero, a3, label4
label93:
