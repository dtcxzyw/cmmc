...
pcrel1782:
	...
	addi s0, a0, %pcrel_lo(pcrel1782)
pcrel1783:
	auipc a0, %pcrel_hi(my_y1)
	addi a0, a0, %pcrel_lo(pcrel1783)
pcrel1784:
	auipc a1, %pcrel_hi(my_y2)
	addi a1, a1, %pcrel_lo(pcrel1784)
	mv a4, zero
	li a2, 512
