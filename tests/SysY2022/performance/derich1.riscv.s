...
pcrel1759:
	...
	addi s0, a0, %pcrel_lo(pcrel1759)
pcrel1760:
	auipc a0, %pcrel_hi(my_y1)
	addi a0, a0, %pcrel_lo(pcrel1760)
pcrel1761:
	auipc a1, %pcrel_hi(my_y2)
	addi a1, a1, %pcrel_lo(pcrel1761)
	mv a2, zero
	li a3, 512
