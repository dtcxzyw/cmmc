...
pcrel296:
	...
	addi a0, a0, %pcrel_lo(pcrel296)
	mv s3, a0
	jal getarray
	mv s4, a0
pcrel297:
	auipc a0, %pcrel_hi(values)
	addi a0, a0, %pcrel_lo(pcrel297)
	mv s5, a0
	jal getarray
pcrel298:
	auipc a0, %pcrel_hi(requests)
	addi a0, a0, %pcrel_lo(pcrel298)
	mv s2, a0
	jal getarray
	mv s1, a0
	li a0, 78
