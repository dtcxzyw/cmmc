...
pcrel305:
	...
	addi s0, a0, %pcrel_lo(pcrel305)
pcrel306:
	auipc a0, %pcrel_hi(head)
	addi a3, a0, %pcrel_lo(pcrel306)
pcrel307:
	auipc a0, %pcrel_hi(key)
	addi a4, a0, %pcrel_lo(pcrel307)
pcrel308:
	auipc a0, %pcrel_hi(value)
	addi a5, a0, %pcrel_lo(pcrel308)
pcrel309:
	auipc a0, %pcrel_hi(nextvalue)
	addi t1, a0, %pcrel_lo(pcrel309)
pcrel310:
	auipc a0, %pcrel_hi(next)
	addi t2, a0, %pcrel_lo(pcrel310)
	ble s5, zero, label2
	mv a0, zero
	mv a1, zero
	j label18
