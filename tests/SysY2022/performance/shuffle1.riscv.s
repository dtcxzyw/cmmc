...
pcrel287:
	...
	addi a3, a1, %pcrel_lo(pcrel287)
pcrel288:
	auipc a1, %pcrel_hi(value)
	addi a0, a1, %pcrel_lo(pcrel288)
pcrel289:
	auipc a1, %pcrel_hi(next)
	addi a4, a1, %pcrel_lo(pcrel289)
	addi a1, a5, %pcrel_lo(pcrel285)
	ble s4, zero, label14
	mv t0, zero
	mv a5, zero
	mv t1, s3
