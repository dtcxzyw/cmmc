; ModuleID = 'tests//SysY2022/performance/dead-code-elimination-1.sy'
source_filename = "tests//SysY2022/performance/dead-code-elimination-1.sy"
...
define dso_local void @_Z4funci(i32 noundef %0) local_unnamed_addr #0 {
  store i32 %0, i32* @global, align 4, !tbaa !4
  ret void
}
...
33:                                               ; preds = %25, %30
  ...
  %35 = add i32 %2, -1
  store i32 %35, i32* @global, align 4, !tbaa !4
  br label %36
