...
pcrel199:
	...
	mv s4, a0
	addi a0, a1, %pcrel_lo(pcrel199)
	mv s5, a0
	jal getarray
pcrel200:
	auipc a1, %pcrel_hi(requests)
	addi a0, a1, %pcrel_lo(pcrel200)
	mv s2, a0
	jal getarray
	mv s1, a0
	li a0, 78
...
pcrel203:
	...
	addi a2, a0, %pcrel_lo(pcrel202)
	addi a3, a1, %pcrel_lo(pcrel203)
pcrel204:
	auipc a1, %pcrel_hi(value)
	addi a0, a1, %pcrel_lo(pcrel204)
pcrel205:
	auipc a1, %pcrel_hi(next)
	addi a4, a1, %pcrel_lo(pcrel205)
	addi a1, a5, %pcrel_lo(pcrel201)
	bgt s4, zero, label50
	bgt s1, zero, label16
	j label15
label50:
