...
pcrel317:
	...
	li s10, 3
	fmv.w.x f18, zero
	addi s8, a2, %pcrel_lo(pcrel314)
	addi s0, a1, %pcrel_lo(pcrel315)
	fmv.w.x f9, s6
	addi s4, a0, %pcrel_lo(pcrel316)
	addi s3, s9, %pcrel_lo(pcrel317)
	fmv.s f8, f18
pcrel318:
	auipc a1, %pcrel_hi(__cmmc_fp_constant_pool)
	mv a0, zero
	addi s5, a1, %pcrel_lo(pcrel318)
	lui a1, 122
	addiw s7, a1, 288
	j label92
.p2align 2
