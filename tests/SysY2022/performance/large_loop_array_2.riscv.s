...
pcrel312:
	...
	li s10, 3
	fmv.w.x f18, zero
	addi s8, a2, %pcrel_lo(pcrel309)
	addi s0, a1, %pcrel_lo(pcrel310)
	fmv.w.x f9, s6
	addi s4, a0, %pcrel_lo(pcrel311)
	addi s3, s9, %pcrel_lo(pcrel312)
	fmv.s f8, f18
pcrel313:
	auipc a1, %pcrel_hi(__cmmc_fp_constant_pool)
	mv a0, zero
	addi s5, a1, %pcrel_lo(pcrel313)
	lui a1, 122
	addiw s7, a1, 288
	j label92
.p2align 2
