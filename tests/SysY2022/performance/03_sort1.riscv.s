...
pcrel626:
	...
	addi a2, a3, %pcrel_lo(pcrel625)
	addi a0, s1, %pcrel_lo(pcrel626)
	sd zero, %pcrel_lo(pcrel626)(s1)
	sw s0, 8(a0)
	mv a1, s0
	mv a0, zero
	jal cmmcParallelFor
	li a0, 102
	lw a1, %pcrel_lo(pcrel626)(s1)
	subw a2, zero, a1
	max s0, a2, a1
	jal _sysy_stoptime
	mv a0, s0
