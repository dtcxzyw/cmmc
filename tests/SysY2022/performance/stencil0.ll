...
75:                                               ; preds = %54
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* noundef nonnull align 16 dereferenceable(2048) bitcast ([524288 x i32]* @image_out to i8*), i8* noundef nonnull align 16 dereferenceable(2048) bitcast ([524288 x i32]* @image_in to i8*), i64 2048, i1 false), !tbaa !5
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* noundef nonnull align 16 dereferenceable(2048) bitcast (i32* getelementptr inbounds ([524288 x i32], [524288 x i32]* @image_out, i64 0, i64 523776) to i8*), i8* noundef nonnull align 16 dereferenceable(2048) bitcast (i32* getelementptr inbounds ([524288 x i32], [524288 x i32]* @image_in, i64 0, i64 523776) to i8*), i64 2048, i1 false), !tbaa !5
