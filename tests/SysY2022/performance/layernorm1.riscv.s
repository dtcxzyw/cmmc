...
pcrel1174:
	...
	sd s8, 24(sp)
	addi s8, s7, %pcrel_lo(pcrel1174)
	sd s6, 32(sp)
	addi s6, a0, %pcrel_lo(pcrel1173)
	sd s1, 40(sp)
	li a0, 125
	sd s5, 48(sp)
	slli s1, a0, 5
	addi s5, a1, %pcrel_lo(pcrel1172)
	sd s0, 56(sp)
	li s0, 1000
	sd s9, 64(sp)
	mv s9, s4
...
pcrel1175:
	...
	sd s6, %pcrel_lo(label608)(a0)
	addi a2, a3, %pcrel_lo(pcrel1175)
	mv a1, s0
	mv a0, zero
	jal cmmcParallelFor
	mv a0, zero
...
pcrel1177:
	auipc s7, %pcrel_hi(cmmc_parallel_body_payload_1)
	sd s5, %pcrel_lo(pcrel1177)(s7)
	addi a2, a3, %pcrel_lo(pcrel1176)
	sd s6, 8(s8)
	mv a1, s0
	jal cmmcParallelFor
	fmv.s f12, f8
...
pcrel597:
	...
	lui t1, 280480
	li t4, 125
	ld a5, %pcrel_lo(pcrel596)(a2)
	addi t0, a2, %pcrel_lo(pcrel596)
pcrel598:
	auipc a2, %pcrel_hi(__cmmc_fp_constant_pool)
	ld a1, 8(t0)
	addi t0, t2, %pcrel_lo(pcrel597)
	sh2add a4, a0, a1
	slli t2, t4, 5
	lui a1, 258048
	addi a0, a2, %pcrel_lo(pcrel598)
	li a2, 992
	mul t5, t3, t2
	flw f10, 0(a4)
	fmv.w.x f11, zero
...
label382:
	...
	fabs.s f15, f0
	flt.s t4, f1, f15
	beq t4, zero, label591
.p2align 2
label380:
	flt.s t4, f10, f14
	bne t4, zero, label382
	fadd.s f15, f11, f12
	fmv.s f13, f11
	flw f1, 4(a0)
	fmv.w.x f0, a1
