; ModuleID = 'tests//SysY2022/performance/large_loop_array_1.sy'
source_filename = "tests//SysY2022/performance/large_loop_array_1.sy"
...
46:                                               ; preds = %40
  ...
  %48 = fadd float %37, %47
  %49 = getelementptr inbounds [2048 x float], [2048 x float]* %1, i64 0, i64 %41
  store float %48, float* %49, align 4, !tbaa !4
  %50 = fadd float %38, %47
  %51 = getelementptr inbounds [2048 x float], [2048 x float]* %2, i64 0, i64 %41
...
58:                                               ; preds = %56, %58
  ...
  %62 = getelementptr inbounds [2048 x float], [2048 x float]* %1, i64 0, i64 %59
  %63 = load float, float* %62, align 16, !tbaa !4
  %64 = getelementptr inbounds [2048 x float], [2048 x float]* %2, i64 0, i64 %59
  %65 = load float, float* %64, align 16, !tbaa !4
  %66 = tail call float @llvm.fmuladd.f32(float %63, float %65, float %60) #5
  %67 = or i64 %59, 1
  %68 = getelementptr inbounds [2048 x float], [2048 x float]* %1, i64 0, i64 %67
  %69 = load float, float* %68, align 4, !tbaa !4
  %70 = getelementptr inbounds [2048 x float], [2048 x float]* %2, i64 0, i64 %67
  %71 = load float, float* %70, align 4, !tbaa !4
  %72 = tail call float @llvm.fmuladd.f32(float %69, float %71, float %66) #5
  %73 = or i64 %59, 2
  %74 = getelementptr inbounds [2048 x float], [2048 x float]* %1, i64 0, i64 %73
  %75 = load float, float* %74, align 8, !tbaa !4
  %76 = getelementptr inbounds [2048 x float], [2048 x float]* %2, i64 0, i64 %73
  %77 = load float, float* %76, align 8, !tbaa !4
  %78 = tail call float @llvm.fmuladd.f32(float %75, float %77, float %72) #5
  %79 = or i64 %59, 3
  %80 = getelementptr inbounds [2048 x float], [2048 x float]* %1, i64 0, i64 %79
  %81 = load float, float* %80, align 4, !tbaa !4
  %82 = getelementptr inbounds [2048 x float], [2048 x float]* %2, i64 0, i64 %79
...
88:                                               ; preds = %53, %88
  ...
  %92 = fadd float %37, %91
  %93 = getelementptr inbounds [2048 x float], [2048 x float]* %1, i64 0, i64 %89
  store float %92, float* %93, align 4, !tbaa !4
  %94 = fadd float %38, %91
  %95 = getelementptr inbounds [2048 x float], [2048 x float]* %2, i64 0, i64 %89
  store float %94, float* %95, align 4, !tbaa !4
  %96 = add nsw i64 %89, 1
  %97 = trunc i64 %96 to i32
  %98 = sitofp i32 %97 to float
  %99 = fadd float %37, %98
  %100 = getelementptr inbounds [2048 x float], [2048 x float]* %1, i64 0, i64 %96
  store float %99, float* %100, align 4, !tbaa !4
  %101 = fadd float %38, %98
  %102 = getelementptr inbounds [2048 x float], [2048 x float]* %2, i64 0, i64 %96
...
109:                                              ; preds = %105, %109
  ...
  %113 = getelementptr inbounds [2048 x float], [2048 x float]* %1, i64 0, i64 %110
  %114 = load float, float* %113, align 4, !tbaa !4
  %115 = getelementptr inbounds [2048 x float], [2048 x float]* %2, i64 0, i64 %110
...
150:                                              ; preds = %144
  ...
  %153 = getelementptr inbounds [2048 x float], [2048 x float]* %1, i64 0, i64 %145
  store float %152, float* %153, align 4, !tbaa !4
  %154 = fadd float %142, %151
  %155 = getelementptr inbounds [2048 x float], [2048 x float]* %2, i64 0, i64 %145
...
160:                                              ; preds = %157, %160
  ...
  %165 = getelementptr inbounds [2048 x float], [2048 x float]* %1, i64 0, i64 %161
  store float %164, float* %165, align 4, !tbaa !4
  %166 = fadd float %142, %163
  %167 = getelementptr inbounds [2048 x float], [2048 x float]* %2, i64 0, i64 %161
  store float %166, float* %167, align 4, !tbaa !4
  %168 = add nsw i64 %161, 1
  %169 = trunc i64 %168 to i32
  %170 = sitofp i32 %169 to float
  %171 = fadd float %141, %170
  %172 = getelementptr inbounds [2048 x float], [2048 x float]* %1, i64 0, i64 %168
  store float %171, float* %172, align 4, !tbaa !4
  %173 = fadd float %142, %170
  %174 = getelementptr inbounds [2048 x float], [2048 x float]* %2, i64 0, i64 %168
...
181:                                              ; preds = %121
  ...
  %183 = fadd double %182, 0xC314537800000000
  br label %184

184:                                              ; preds = %177, %181, %0
  %185 = phi double [ 0xC314537800000000, %0 ], [ %183, %181 ], [ 0xC314537800000000, %177 ]
