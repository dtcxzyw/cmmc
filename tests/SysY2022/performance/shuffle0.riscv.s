...
pcrel214:
	...
	addi a2, a0, %pcrel_lo(pcrel213)
	addi a3, a1, %pcrel_lo(pcrel214)
pcrel215:
	auipc a1, %pcrel_hi(value)
	addi a0, a1, %pcrel_lo(pcrel215)
pcrel216:
	auipc a1, %pcrel_hi(next)
	addi a4, a1, %pcrel_lo(pcrel216)
	addi a1, a5, %pcrel_lo(pcrel212)
	ble s4, zero, label47
	mv t0, zero
	mv a5, zero
	j label2
