...
pcrel1020:
	...
	addi s0, a1, %pcrel_lo(pcrel1020)
pcrel1021:
	auipc a1, %pcrel_hi(cmmc_parallel_body_0)
	sd s0, %pcrel_lo(pcrel1019)(a0)
	addi a2, a1, %pcrel_lo(pcrel1021)
	mv a0, zero
	addiw a1, a3, 1696
	jal cmmcParallelFor
pcrel1022:
...
pcrel1023:
	...
	addi a3, a1, %pcrel_lo(pcrel1022)
	addi s1, a0, %pcrel_lo(pcrel1023)
	j label111
.p2align 2
label201:
	addiw a4, a4, 1
