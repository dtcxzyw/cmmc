; ModuleID = 'tests//SysY2022/final_performance/04_spmv1.sy'
source_filename = "tests//SysY2022/final_performance/04_spmv1.sy"
...
8:                                                ; preds = %6
  ...
  call void @llvm.memset.p0i8.i64(i8* align 4 %9, i8 0, i64 %11, i1 false), !tbaa !5
...
14:                                               ; preds = %50, %43
  ...
  br i1 %16, label %67, label %17, !llvm.loop !9
...
50:                                               ; preds = %47, %50
  ...
  br i1 %66, label %50, label %14, !llvm.loop !12
...
10:                                               ; preds = %0, %223
  ...
  tail call void @llvm.memset.p0i8.i64(i8* align 16 bitcast ([100010 x i32]* @b to i8*), i8 0, i64 %8, i1 false) #4, !tbaa !5
  br label %12
...
92:                                               ; preds = %88, %92
  ...
  br i1 %114, label %115, label %92, !llvm.loop !12

115:                                              ; preds = %88, %92, %64
  %116 = icmp eq i64 %16, %7
  br i1 %116, label %117, label %12, !llvm.loop !9

117:                                              ; preds = %115
  tail call void @llvm.memset.p0i8.i64(i8* align 16 bitcast ([100010 x i32]* @a to i8*), i8 0, i64 %8, i1 false) #4, !tbaa !5
  br label %118
...
147:                                              ; preds = %143, %147
  ...
  br i1 %167, label %168, label %147, !llvm.loop !11
...
198:                                              ; preds = %194, %198
  ...
  br i1 %220, label %221, label %198, !llvm.loop !12

221:                                              ; preds = %194, %198, %170
  %222 = icmp eq i64 %122, %7
  br i1 %222, label %223, label %118, !llvm.loop !9

223:                                              ; preds = %221
  %224 = add nuw nsw i32 %11, 1
  %225 = icmp eq i32 %224, 100
  br i1 %225, label %226, label %10, !llvm.loop !13
