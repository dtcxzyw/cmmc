; ModuleID = 'tests//SysY2022/final_performance/shuffle1.sy'
source_filename = "tests//SysY2022/final_performance/shuffle1.sy"
...
define dso_local noundef i32 @_Z4hashi(i32 noundef %0) local_unnamed_addr #0 {
  %2 = load i32, i32* @hashmod, align 4, !tbaa !5
  %3 = srem i32 %0, %2
  ret i32 %3
}
...
define dso_local noundef i32 @_Z6insertii(i32 noundef %0, i32 noundef %1) local_unnamed_addr #1 {
  %3 = load i32, i32* @hashmod, align 4, !tbaa !5
  %4 = srem i32 %0, %3
  %5 = sext i32 %4 to i64
...
35:                                               ; preds = %31
  ...
  %37 = add nsw i32 %36, 1
  store i32 %37, i32* @cnt, align 4, !tbaa !5
...
define dso_local noundef i32 @main() local_unnamed_addr #2 {
  ...
  store i32 %1, i32* @hashmod, align 4, !tbaa !5
...
6:                                                ; preds = %0
  ...
  %8 = load i32, i32* @hashmod, align 4, !tbaa !5
  %9 = zext i32 %2 to i64
  br label %15
...
12:                                               ; preds = %10
  %13 = load i32, i32* @hashmod, align 4, !tbaa !5
...
40:                                               ; preds = %34
  ...
  store i32 %21, i32* %46, align 4, !tbaa !5
  br label %58
...
51:                                               ; preds = %47
  ...
  store i32 %25, i32* %54, align 4, !tbaa !5
  ...
  store i32 %21, i32* %56, align 4, !tbaa !5
...
58:                                               ; preds = %27, %40, %51
  ...
  %61 = icmp eq i64 %60, %9
  br i1 %61, label %10, label %15, !llvm.loop !13
...
77:                                               ; preds = %71, %77
  ...
  %86 = icmp eq i32 %85, 0
  br i1 %86, label %91, label %77, !llvm.loop !11
