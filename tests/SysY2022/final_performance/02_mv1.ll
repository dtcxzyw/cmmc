; ModuleID = 'tests//SysY2022/final_performance/02_mv1.sy'
source_filename = "tests//SysY2022/final_performance/02_mv1.sy"
...
6:                                                ; preds = %4
  ...
  call void @llvm.memset.p0i8.i64(i8* align 4 %7, i8 0, i64 %9, i1 false), !tbaa !4
...
20:                                               ; preds = %18, %20
  ...
  store i32 %22, i32* %23, align 4, !tbaa !4
...
38:                                               ; preds = %28, %131
  ...
  tail call void @llvm.memset.p0i8.i64(i8* align 16 bitcast ([2010 x i32]* @C to i8*), i8 0, i64 %27, i1 false) #4, !tbaa !4
  br label %40
...
66:                                               ; preds = %60, %55
  ...
  br i1 %69, label %70, label %43, !llvm.loop !8
...
85:                                               ; preds = %82
  tail call void @llvm.memset.p0i8.i64(i8* align 16 bitcast ([2010 x i32]* @B to i8*), i8 0, i64 %27, i1 false) #4, !tbaa !4
  br label %86
...
89:                                               ; preds = %86, %112
  ...
  %93 = load i32, i32* %92, align 8, !tbaa !4
  %94 = icmp eq i32 %93, 0
  br i1 %94, label %101, label %95

95:                                               ; preds = %89
  %96 = load i32, i32* %88, align 4, !tbaa !4
  %97 = getelementptr inbounds [2010 x i32], [2010 x i32]* @C, i64 0, i64 %90
  %98 = load i32, i32* %97, align 8, !tbaa !4
  %99 = mul nsw i32 %98, %93
  %100 = add nsw i32 %99, %96
  store i32 %100, i32* %88, align 4, !tbaa !4
  br label %101
...
106:                                              ; preds = %101
  %107 = load i32, i32* %88, align 4, !tbaa !4
  ...
  store i32 %111, i32* %88, align 4, !tbaa !4
  br label %112
...
112:                                              ; preds = %106, %101
  ...
  br i1 %115, label %116, label %89, !llvm.loop !8
...
122:                                              ; preds = %118
  %123 = load i32, i32* %88, align 4, !tbaa !4
  ...
  store i32 %127, i32* %88, align 4, !tbaa !4
  br label %128

128:                                              ; preds = %118, %122, %116
  %129 = add nuw nsw i64 %87, 1
  %130 = icmp eq i64 %129, %19
  br i1 %130, label %131, label %86, !llvm.loop !10
