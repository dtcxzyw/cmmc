; ModuleID = 'tests//SysY2022/final_performance/gameoflife-oscillator.sy'
source_filename = "tests//SysY2022/final_performance/gameoflife-oscillator.sy"
...
21:                                               ; preds = %11, %7
  ...
  br i1 %26, label %7, label %27, !llvm.loop !11
...
define dso_local void @_Z7put_mapv() local_unnamed_addr #0 {
  %1 = load i32, i32* @height, align 4, !tbaa !5
  %2 = icmp slt i32 %1, 1
...
3:                                                ; preds = %0
  %4 = load i32, i32* @width, align 4, !tbaa !5
  %5 = icmp slt i32 %4, 1
...
14:                                               ; preds = %14, %12
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %19, i8* align 4 %21, i64 %8, i1 false), !tbaa !5
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %24, i8* align 4 %26, i64 %8, i1 false), !tbaa !5
  %27 = add i64 %16, 2
...
34:                                               ; preds = %31
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %36, i8* align 4 %38, i64 %8, i1 false), !tbaa !5
  br label %39
...
62:                                               ; preds = %58
  %63 = load i32, i32* @height, align 4, !tbaa !5
  br label %64
...
64:                                               ; preds = %13, %62
  ...
  br i1 %69, label %8, label %70, !llvm.loop !16
...
define dso_local noundef i32 @main() local_unnamed_addr #3 {
  ...
  %1 = load i32, i32* @steps, align 4, !tbaa !5
  %2 = icmp sgt i32 %1, 0
  br i1 %2, label %3, label %129

3:                                                ; preds = %0
  %4 = load i32, i32* @active, align 4, !tbaa !5
...
17:                                               ; preds = %16
  %18 = load i32, i32* getelementptr inbounds ([500 x [500 x i32]], [500 x [500 x i32]]* @sheet1, i64 0, i64 0, i64 0), align 16, !tbaa !5
  %19 = load i32, i32* getelementptr inbounds ([500 x [500 x i32]], [500 x [500 x i32]]* @sheet1, i64 0, i64 0, i64 1), align 4, !tbaa !5
  %20 = load i32, i32* getelementptr inbounds ([500 x [500 x i32]], [500 x [500 x i32]]* @sheet1, i64 0, i64 1, i64 0), align 16, !tbaa !5
  %21 = load i32, i32* getelementptr inbounds ([500 x [500 x i32]], [500 x [500 x i32]]* @sheet1, i64 0, i64 1, i64 1), align 4, !tbaa !5
  br label %22
...
68:                                               ; preds = %66
  ...
  br i1 %69, label %124, label %22, !llvm.loop !16

70:                                               ; preds = %12
  br i1 %9, label %124, label %71

71:                                               ; preds = %70
  %72 = load i32, i32* getelementptr inbounds ([500 x [500 x i32]], [500 x [500 x i32]]* @sheet2, i64 0, i64 0, i64 0), align 16, !tbaa !5
  %73 = load i32, i32* getelementptr inbounds ([500 x [500 x i32]], [500 x [500 x i32]]* @sheet2, i64 0, i64 0, i64 1), align 4, !tbaa !5
  %74 = load i32, i32* getelementptr inbounds ([500 x [500 x i32]], [500 x [500 x i32]]* @sheet2, i64 0, i64 1, i64 0), align 16, !tbaa !5
  %75 = load i32, i32* getelementptr inbounds ([500 x [500 x i32]], [500 x [500 x i32]]* @sheet2, i64 0, i64 1, i64 1), align 4, !tbaa !5
  br label %76
...
122:                                              ; preds = %120
  ...
  br i1 %123, label %124, label %76, !llvm.loop !16

124:                                              ; preds = %122, %68, %70, %16
  %125 = phi i32 [ 2, %16 ], [ 1, %70 ], [ 2, %68 ], [ 1, %122 ]
  %126 = add nsw i32 %13, -1
  %127 = icmp sgt i32 %13, 1
  br i1 %127, label %12, label %128, !llvm.loop !18

128:                                              ; preds = %124
  store i32 %125, i32* @active, align 4, !tbaa !5
  store i32 0, i32* @steps, align 4, !tbaa !5
  br label %129

129:                                              ; preds = %128, %0
  tail call void @_Z14_sysy_stoptimei(i32 noundef 106)
  %130 = load i32, i32* @active, align 4, !tbaa !5
  %131 = icmp eq i32 %130, 2
  %132 = load i32, i32* @height, align 4, !tbaa !5
...
146:                                              ; preds = %146, %144
  ...
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %151, i8* align 4 %153, i64 %140, i1 false) #5, !tbaa !5
  ...
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %156, i8* align 4 %158, i64 %140, i1 false) #5, !tbaa !5
  %159 = add i64 %148, 2
  %160 = icmp eq i64 %159, %145
  br i1 %160, label %161, label %146, !llvm.loop !14
...
166:                                              ; preds = %163
  ...
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %168, i8* align 4 %170, i64 %140, i1 false) #5, !tbaa !5
  br label %171
...
174:                                              ; preds = %173, %188
  ...
  %176 = load i32, i32* @width, align 4, !tbaa !5
...
178:                                              ; preds = %174, %178
  ...
  %185 = load i32, i32* @width, align 4, !tbaa !5
  %186 = sext i32 %185 to i64
  %187 = icmp slt i64 %179, %186
  br i1 %187, label %178, label %188, !llvm.loop !12

188:                                              ; preds = %178, %174
  tail call void @_Z5putchi(i32 noundef 10)
  %189 = add nuw nsw i64 %175, 1
  %190 = load i32, i32* @height, align 4, !tbaa !5
  %191 = sext i32 %190 to i64
  %192 = icmp slt i64 %175, %191
  br i1 %192, label %174, label %193, !llvm.loop !13
