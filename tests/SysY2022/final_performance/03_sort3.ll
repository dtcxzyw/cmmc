; ModuleID = 'tests//SysY2022/final_performance/03_sort3.sy'
source_filename = "tests//SysY2022/final_performance/03_sort3.sy"
...
73:                                               ; preds = %70, %73
  ...
  %76 = getelementptr inbounds i32, i32* %1, i64 %74
...
10:                                               ; preds = %10, %8
  ...
  %14 = add i32 %12, 4
  %15 = icmp eq i32 %14, %9
  br i1 %15, label %16, label %10, !llvm.loop !14
...
42:                                               ; preds = %39, %42
  ...
  br i1 %47, label %48, label %42, !llvm.loop !17
...
69:                                               ; preds = %63, %60
  ...
  br i1 %76, label %29, label %88, !llvm.loop !19
...
77:                                               ; preds = %15, %77
  ...
  br i1 %87, label %77, label %88, !llvm.loop !19

88:                                               ; preds = %77, %69
  %89 = getelementptr inbounds [16 x i32], [16 x i32]* %5, i64 0, i64 0
  store i32 %2, i32* %89, align 16, !tbaa !5
  ...
  store i32 %127, i32* %129, align 16, !tbaa !5
  ...
  store i32 %157, i32* %159, align 8, !tbaa !5
...
198:                                              ; preds = %318, %191
  ...
  br i1 %200, label %365, label %191, !llvm.loop !20
...
208:                                              ; preds = %206, %208
  ...
  br i1 %213, label %214, label %208, !llvm.loop !14
...
217:                                              ; preds = %214, %217
  ...
  br i1 %222, label %223, label %217, !llvm.loop !21
...
229:                                              ; preds = %228, %229
  ...
  br i1 %234, label %235, label %229, !llvm.loop !14
...
253:                                              ; preds = %244, %253
  ...
  br i1 %258, label %259, label %253, !llvm.loop !14
...
268:                                              ; preds = %262, %259
  ...
  store i32 %207, i32* %275, align 4, !tbaa !5
...
276:                                              ; preds = %268, %276
  ...
  br i1 %281, label %282, label %276, !llvm.loop !14
...
285:                                              ; preds = %282, %285
  ...
  br i1 %290, label %291, label %285, !llvm.loop !24
...
297:                                              ; preds = %291, %297
  ...
  br i1 %302, label %303, label %297, !llvm.loop !14
...
306:                                              ; preds = %303, %306
  ...
  br i1 %311, label %312, label %306, !llvm.loop !25
...
318:                                              ; preds = %223
  %319 = load i32, i32* %193, align 4, !tbaa !5
  %320 = sext i32 %319 to i64
  %321 = getelementptr inbounds i32, i32* %1, i64 %320
  store i32 %207, i32* %321, align 4, !tbaa !5
  %322 = add nsw i32 %319, 1
  store i32 %322, i32* %193, align 4, !tbaa !5
  %323 = icmp slt i32 %322, %195
  br i1 %323, label %201, label %198, !llvm.loop !27
...
324:                                              ; preds = %88, %362
  ...
  %329 = load i32, i32* %326, align 4, !tbaa !5
...
339:                                              ; preds = %331, %339
  ...
  store i32 %340, i32* %346, align 4, !tbaa !5
  %348 = add nsw i32 %344, 1
  store i32 %348, i32* %343, align 4, !tbaa !5
  %349 = srem i32 %347, 16
  %350 = zext i32 %349 to i64
  %351 = icmp eq i64 %325, %350
  br i1 %351, label %352, label %339, !llvm.loop !26

352:                                              ; preds = %339
  %353 = load i32, i32* %326, align 4, !tbaa !5
...
355:                                              ; preds = %352, %331
  ...
  store i32 %360, i32* %326, align 4, !tbaa !5
  %361 = icmp slt i32 %360, %328
  br i1 %361, label %331, label %362, !llvm.loop !27

362:                                              ; preds = %355, %324
  %363 = add nuw nsw i64 %325, 1
  %364 = icmp eq i64 %363, 16
  br i1 %364, label %365, label %324, !llvm.loop !20
...
365:                                              ; preds = %362, %198
  ...
  store i32 %372, i32* %374, align 8, !tbaa !5
  ...
  store i32 %397, i32* %398, align 8, !tbaa !5
  ...
  store i32 %402, i32* %404, align 16, !tbaa !5
  ...
  store i32 %422, i32* %424, align 16, !tbaa !5
  ...
  store i32 %432, i32* %434, align 8, !tbaa !5
...
define dso_local noundef i32 @main() local_unnamed_addr #5 {
  ...
  %2 = load i32, i32* @ans, align 4, !tbaa !5
  %3 = icmp sgt i32 %1, 0
...
10:                                               ; preds = %10, %8
  ...
  %32 = add i64 %13, 2
  %33 = icmp eq i64 %32, %9
  br i1 %33, label %34, label %10, !llvm.loop !28
