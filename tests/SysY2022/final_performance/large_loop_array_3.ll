; ModuleID = 'tests//SysY2022/final_performance/large_loop_array_3.sy'
source_filename = "tests//SysY2022/final_performance/large_loop_array_3.sy"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@COUNT = dso_local local_unnamed_addr global i32 100000, align 4
...
define dso_local noundef i32 @main() local_unnamed_addr #3 {
  %1 = alloca [8192 x float], align 16
  %2 = alloca [8192 x float], align 16
  %3 = tail call noundef i32 @_Z6getintv()
  %4 = bitcast [8192 x float]* %1 to i8*
  call void @llvm.lifetime.start.p0i8(i64 32768, i8* nonnull %4) #5
