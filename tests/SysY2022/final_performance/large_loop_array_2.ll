...
49:                                               ; preds = %49, %47
  ...
  %56 = getelementptr inbounds [4096 x float], [4096 x float]* %1, i64 0, i64 %53
  %57 = bitcast float* %56 to <4 x float>*
  store <4 x float> %55, <4 x float>* %57, align 4, !tbaa !5
  %58 = fadd <4 x float> %41, %54
  %59 = getelementptr inbounds [4096 x float], [4096 x float]* %2, i64 0, i64 %53
  ...
  %66 = getelementptr inbounds [4096 x float], [4096 x float]* %1, i64 0, i64 %63
  %67 = bitcast float* %66 to <4 x float>*
  store <4 x float> %65, <4 x float>* %67, align 4, !tbaa !5
  %68 = fadd <4 x float> %41, %64
  %69 = getelementptr inbounds [4096 x float], [4096 x float]* %2, i64 0, i64 %63
...
79:                                               ; preds = %75
  ...
  %83 = getelementptr inbounds [4096 x float], [4096 x float]* %1, i64 0, i64 %80
  %84 = bitcast float* %83 to <4 x float>*
  store <4 x float> %82, <4 x float>* %84, align 4, !tbaa !5
  %85 = fadd <4 x float> %41, %81
  %86 = getelementptr inbounds [4096 x float], [4096 x float]* %2, i64 0, i64 %80
...
96:                                               ; preds = %94, %96
  ...
  %100 = getelementptr inbounds [4096 x float], [4096 x float]* %1, i64 0, i64 %97
  %101 = load float, float* %100, align 16, !tbaa !5
  %102 = getelementptr inbounds [4096 x float], [4096 x float]* %2, i64 0, i64 %97
  %103 = load float, float* %102, align 16, !tbaa !5
  %104 = tail call float @llvm.fmuladd.f32(float %101, float %103, float %98) #5
  %105 = or i64 %97, 1
  %106 = getelementptr inbounds [4096 x float], [4096 x float]* %1, i64 0, i64 %105
  %107 = load float, float* %106, align 4, !tbaa !5
  %108 = getelementptr inbounds [4096 x float], [4096 x float]* %2, i64 0, i64 %105
  %109 = load float, float* %108, align 4, !tbaa !5
  %110 = tail call float @llvm.fmuladd.f32(float %107, float %109, float %104) #5
  %111 = or i64 %97, 2
  %112 = getelementptr inbounds [4096 x float], [4096 x float]* %1, i64 0, i64 %111
  %113 = load float, float* %112, align 8, !tbaa !5
  %114 = getelementptr inbounds [4096 x float], [4096 x float]* %2, i64 0, i64 %111
  %115 = load float, float* %114, align 8, !tbaa !5
  %116 = tail call float @llvm.fmuladd.f32(float %113, float %115, float %110) #5
  %117 = or i64 %97, 3
  %118 = getelementptr inbounds [4096 x float], [4096 x float]* %1, i64 0, i64 %117
  %119 = load float, float* %118, align 4, !tbaa !5
  %120 = getelementptr inbounds [4096 x float], [4096 x float]* %2, i64 0, i64 %117
...
126:                                              ; preds = %90, %126
  ...
  %131 = getelementptr inbounds [4096 x float], [4096 x float]* %1, i64 0, i64 %127
  store float %130, float* %131, align 4, !tbaa !5
  %132 = fadd float %93, %129
  %133 = getelementptr inbounds [4096 x float], [4096 x float]* %2, i64 0, i64 %127
...
140:                                              ; preds = %136, %140
  ...
  %144 = getelementptr inbounds [4096 x float], [4096 x float]* %1, i64 0, i64 %141
  %145 = load float, float* %144, align 4, !tbaa !5
  %146 = getelementptr inbounds [4096 x float], [4096 x float]* %2, i64 0, i64 %141
...
187:                                              ; preds = %187, %185
  ...
  %194 = getelementptr inbounds [4096 x float], [4096 x float]* %1, i64 0, i64 %191
  %195 = bitcast float* %194 to <4 x float>*
  store <4 x float> %193, <4 x float>* %195, align 4, !tbaa !5
  %196 = fadd <4 x float> %179, %192
  %197 = getelementptr inbounds [4096 x float], [4096 x float]* %2, i64 0, i64 %191
  ...
  %204 = getelementptr inbounds [4096 x float], [4096 x float]* %1, i64 0, i64 %201
  %205 = bitcast float* %204 to <4 x float>*
  store <4 x float> %203, <4 x float>* %205, align 4, !tbaa !5
  %206 = fadd <4 x float> %179, %202
  %207 = getelementptr inbounds [4096 x float], [4096 x float]* %2, i64 0, i64 %201
...
217:                                              ; preds = %213
  ...
  %221 = getelementptr inbounds [4096 x float], [4096 x float]* %1, i64 0, i64 %218
  %222 = bitcast float* %221 to <4 x float>*
  store <4 x float> %220, <4 x float>* %222, align 4, !tbaa !5
  %223 = fadd <4 x float> %179, %219
  %224 = getelementptr inbounds [4096 x float], [4096 x float]* %2, i64 0, i64 %218
...
232:                                              ; preds = %228, %232
  ...
  %237 = getelementptr inbounds [4096 x float], [4096 x float]* %1, i64 0, i64 %233
  store float %236, float* %237, align 4, !tbaa !5
  %238 = fadd float %231, %235
  %239 = getelementptr inbounds [4096 x float], [4096 x float]* %2, i64 0, i64 %233
...
246:                                              ; preds = %152
  ...
  %248 = fadd double %247, 0xC344536B00000000
  br label %249

249:                                              ; preds = %242, %246, %0
  %250 = phi double [ 0xC344536B00000000, %0 ], [ %248, %246 ], [ 0xC344536B00000000, %242 ]
