; ModuleID = 'tests//SysY2022/final_performance/recursion_fabonacci-2.sy'
source_filename = "tests//SysY2022/final_performance/recursion_fabonacci-2.sy"
...
define dso_local noundef i32 @main() local_unnamed_addr #1 {
  tail call void @_Z15_sysy_starttimei(i32 noundef 20)
  ...
  %10 = fcmp oeq float %8, 0x4182A38140000000
...
13:                                               ; preds = %12, %11
  %14 = fcmp oeq float %9, 1.000000e+00
...
17:                                               ; preds = %16, %15
  tail call void @_Z14_sysy_stoptimei(i32 noundef 41)
  ret i32 0
}
