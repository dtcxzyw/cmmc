...
define dso_local void @_Z8add_edgeii(i32 noundef %0, i32 noundef %1) local_unnamed_addr #2 {
  ...
  %10 = add nsw i32 %3, 1
  store i32 %10, i32* @cnt, align 4, !tbaa !7
...
define dso_local void @_Z4initv() local_unnamed_addr #3 {
  store i32 1061109567, i32* getelementptr inbounds ([10005 x i32], [10005 x i32]* @dep, i64 0, i64 0), align 16, !tbaa !7
...
3:                                                ; preds = %0
  ...
  call void @llvm.memset.p0i8.i64(i8* align 4 bitcast (i32* getelementptr inbounds ([10005 x i32], [10005 x i32]* @head, i64 0, i64 1) to i8*), i8 -1, i64 %5, i1 false), !tbaa !7
  br label %6
...
define dso_local void @_Z4treeii(i32 noundef %0, i32 noundef %1) local_unnamed_addr #4 {
  ...
  %6 = load i32, i32* %5, align 16, !tbaa !7
  %7 = icmp eq i32 %6, 0
...
32:                                               ; preds = %26, %19
  ...
  br i1 %38, label %19, label %39, !llvm.loop !13
...
42:                                               ; preds = %39
  ...
  %128 = load i32, i32* %127, align 8, !tbaa !7
  ...
  %179 = load i32, i32* %178, align 16, !tbaa !7
  ...
  %223 = load i32, i32* %222, align 16, !tbaa !7
  br label %224
...
57:                                               ; preds = %51
  ...
  tail call void @llvm.memset.p0i8.i64(i8* align 4 bitcast (i32* getelementptr inbounds ([10005 x i32], [10005 x i32]* @head, i64 0, i64 1) to i8*), i8 -1, i64 %59, i1 false) #8, !tbaa !7
  %60 = icmp eq i32 %55, 1
...
70:                                               ; preds = %62, %70
  ...
  br i1 %77, label %70, label %67, !llvm.loop !4
...
78:                                               ; preds = %78, %67
  ...
  br i1 %86, label %78, label %87, !llvm.loop !6
...
97:                                               ; preds = %87, %97
  ...
  br i1 %104, label %97, label %94, !llvm.loop !4
...
105:                                              ; preds = %105, %94
  ...
  br i1 %113, label %105, label %114, !llvm.loop !6

114:                                              ; preds = %105
  %115 = icmp eq i32 %96, 0
  %116 = sub nsw i32 0, %110
  %117 = select i1 %115, i32 %110, i32 %116
  %118 = load i32, i32* @cnt, align 4, !tbaa !7
  ...
  store i32 %118, i32* %122, align 4, !tbaa !7
  %125 = add nsw i32 %118, 1
  store i32 %125, i32* @cnt, align 4, !tbaa !7
  %126 = sext i32 %117 to i64
  %127 = getelementptr inbounds [10005 x [20 x i32]], [10005 x [20 x i32]]* @f, i64 0, i64 %126, i64 0
  store i32 %90, i32* %127, align 16, !tbaa !7
  %128 = add nuw nsw i32 %63, 1
  %129 = load i32, i32* @n, align 4, !tbaa !7
  %130 = icmp eq i32 %128, %129
  br i1 %130, label %131, label %62, !llvm.loop !14

131:                                              ; preds = %114, %57
  tail call void @_Z4treeii(i32 noundef 1, i32 noundef 1)
  %132 = load i32, i32* @m, align 4, !tbaa !7
...
168:                                              ; preds = %158, %168
  ...
  br i1 %175, label %168, label %165, !llvm.loop !4
...
176:                                              ; preds = %176, %165
  ...
  br i1 %184, label %176, label %185, !llvm.loop !6
...
185:                                              ; preds = %176
  ...
  %190 = load i32, i32* @m, align 4, !tbaa !7
  %191 = add nsw i32 %190, -1
  store i32 %191, i32* @m, align 4, !tbaa !7
  %192 = icmp eq i32 %191, 0
  br i1 %192, label %193, label %134, !llvm.loop !15
