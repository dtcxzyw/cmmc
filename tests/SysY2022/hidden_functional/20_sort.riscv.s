...
pcrel546:
	auipc a0, %pcrel_hi(a)
	addi s0, a0, %pcrel_lo(pcrel546)
pcrel547:
	auipc a0, %pcrel_hi(b)
	addi s3, a0, %pcrel_lo(pcrel547)
pcrel548:
	auipc a0, %pcrel_hi(c)
...
pcrel550:
	auipc a0, %pcrel_hi(a)
	addi s0, a0, %pcrel_lo(pcrel550)
pcrel551:
	auipc a0, %pcrel_hi(b)
	addi s3, a0, %pcrel_lo(pcrel551)
pcrel552:
	auipc a0, %pcrel_hi(c)
...
pcrel554:
	auipc a0, %pcrel_hi(a)
	addi s0, a0, %pcrel_lo(pcrel554)
pcrel555:
	auipc a0, %pcrel_hi(b)
	addi s3, a0, %pcrel_lo(pcrel555)
pcrel556:
	auipc a0, %pcrel_hi(c)
	addi s1, a0, %pcrel_lo(pcrel556)
