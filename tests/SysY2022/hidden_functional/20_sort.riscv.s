...
pcrel567:
	auipc a1, %pcrel_hi(b)
	addiw s3, a4, -3
	addi s2, a0, %pcrel_lo(pcrel566)
	addi s1, a1, %pcrel_lo(pcrel567)
pcrel568:
	auipc a0, %pcrel_hi(c)
	addi s0, a0, %pcrel_lo(pcrel568)
	beq a4, zero, label26
	mv s7, s2
	mv s8, zero
	j label11
