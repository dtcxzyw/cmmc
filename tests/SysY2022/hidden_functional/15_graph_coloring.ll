...
75:                                               ; preds = %10, %79
  ...
  %77 = tail call noundef i32 @_Z13graphColoringPA4_iiiPi([4 x i32]* noundef %0, i32 noundef %1, i32 noundef %11, i32* noundef %3), !range !9
  %78 = icmp eq i32 %77, 0
...
79:                                               ; preds = %75
  ...
  %80 = add nuw i32 %76, 1
  %81 = icmp eq i32 %76, %1
  br i1 %81, label %82, label %75, !llvm.loop !10
...
define dso_local noundef i32 @main() local_unnamed_addr #4 {
  ...
  call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 16 dereferenceable(16) %3, i8 0, i64 16, i1 false), !tbaa !5
  %5 = getelementptr inbounds [4 x [4 x i32]], [4 x [4 x i32]]* %1, i64 0, i64 0
  %6 = getelementptr inbounds [4 x i32], [4 x i32]* %2, i64 0, i64 0
  %7 = call noundef i32 @_Z13graphColoringPA4_iiiPi([4 x i32]* noundef nonnull %5, i32 noundef 3, i32 noundef 0, i32* noundef nonnull %6), !range !9
  %8 = icmp eq i32 %7, 0
