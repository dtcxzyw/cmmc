...
define dso_local noundef i32 @_Z11detect_itemiPii(i32 noundef %0, i32* noundef %1, i32 noundef %2) local_unnamed_addr #2 {
  %4 = load i32, i32* @pos, align 4, !tbaa !5
  %5 = icmp slt i32 %4, %2
...
17:                                               ; preds = %12, %12, %12, %12
  ...
  store i32 %19, i32* @pos, align 4, !tbaa !5
...
59:                                               ; preds = %56, %64
  ...
  store i32 %62, i32* @pos, align 4, !tbaa !5
  %63 = icmp eq i32 %62, %2
  br i1 %63, label %578, label %64, !llvm.loop !11
...
107:                                              ; preds = %102
  ...
  store i32 %108, i32* @pos, align 4, !tbaa !5
  br label %109
...
117:                                              ; preds = %112
  ...
  store i32 %118, i32* @pos, align 4, !tbaa !5
  br label %119
...
130:                                              ; preds = %124
  ...
  store i32 %132, i32* @pos, align 4, !tbaa !5
  %133 = icmp eq i32 %132, %2
  br i1 %133, label %578, label %124, !llvm.loop !13

134:                                              ; preds = %23
  %135 = add nsw i32 %24, 1
  store i32 %135, i32* @pos, align 4, !tbaa !5
...
143:                                              ; preds = %137, %142
  ...
  store i32 %145, i32* @pos, align 4, !tbaa !5
  %146 = icmp slt i32 %145, %2
  br i1 %146, label %137, label %578, !llvm.loop !14
...
149:                                              ; preds = %23
  %150 = add i32 %24, 1
  store i32 %150, i32* @pos, align 4, !tbaa !5
...
159:                                              ; preds = %154, %154, %154, %154
  ...
  store i32 %161, i32* @pos, align 4, !tbaa !5
  %162 = icmp eq i32 %161, %2
  br i1 %162, label %173, label %154, !llvm.loop !9
...
173:                                              ; preds = %159, %166, %163
  %174 = tail call noundef i32 @_Z11detect_itemiPii(i32 noundef 0, i32* noundef nonnull %1, i32 noundef %2), !range !15
  %175 = icmp eq i32 %174, 0
  br i1 %175, label %578, label %176

176:                                              ; preds = %173
  %177 = load i32, i32* @pos, align 4, !tbaa !5
...
186:                                              ; preds = %181, %181, %181, %181
  ...
  store i32 %188, i32* @pos, align 4, !tbaa !5
...
196:                                              ; preds = %190, %227
  ...
  %198 = add i32 %197, 1
  store i32 %198, i32* @pos, align 4, !tbaa !5
...
206:                                              ; preds = %202, %202, %202, %202
  ...
  store i32 %208, i32* @pos, align 4, !tbaa !5
  %209 = icmp eq i32 %208, %2
  br i1 %209, label %210, label %202, !llvm.loop !9

210:                                              ; preds = %202, %206, %196
  %211 = tail call noundef i32 @_Z11detect_itemiPii(i32 noundef 0, i32* noundef %1, i32 noundef %2), !range !15
  %212 = icmp eq i32 %211, 0
  br i1 %212, label %578, label %213

213:                                              ; preds = %210
  %214 = load i32, i32* @pos, align 4, !tbaa !5
...
223:                                              ; preds = %218, %218, %218, %218
  ...
  store i32 %225, i32* @pos, align 4, !tbaa !5
  %226 = icmp eq i32 %225, %2
  br i1 %226, label %227, label %218, !llvm.loop !9
...
227:                                              ; preds = %218, %223, %213
  ...
  br i1 %232, label %196, label %233, !llvm.loop !16
...
243:                                              ; preds = %238, %238, %238, %238
  ...
  store i32 %245, i32* @pos, align 4, !tbaa !5
  %246 = icmp eq i32 %245, %2
  br i1 %246, label %578, label %238, !llvm.loop !9
...
257:                                              ; preds = %23
  %258 = add i32 %24, 1
  store i32 %258, i32* @pos, align 4, !tbaa !5
...
267:                                              ; preds = %262, %262, %262, %262
  ...
  store i32 %269, i32* @pos, align 4, !tbaa !5
  %270 = icmp eq i32 %269, %2
  br i1 %270, label %578, label %262, !llvm.loop !9
...
285:                                              ; preds = %281, %281, %281, %281
  ...
  store i32 %287, i32* @pos, align 4, !tbaa !5
  %288 = icmp eq i32 %287, %2
  br i1 %288, label %292, label %289, !llvm.loop !9
...
292:                                              ; preds = %285, %281
  ...
  store i32 %294, i32* @pos, align 4, !tbaa !5
...
302:                                              ; preds = %296, %301
  ...
  store i32 %304, i32* @pos, align 4, !tbaa !5
  %305 = icmp slt i32 %304, %2
  br i1 %305, label %296, label %578, !llvm.loop !14

306:                                              ; preds = %296
  %307 = add nsw i32 %297, 1
  store i32 %307, i32* @pos, align 4, !tbaa !5
...
316:                                              ; preds = %311, %311, %311, %311
  ...
  store i32 %318, i32* @pos, align 4, !tbaa !5
  %319 = icmp eq i32 %318, %2
  br i1 %319, label %578, label %311, !llvm.loop !9
...
328:                                              ; preds = %323
  ...
  store i32 %329, i32* @pos, align 4, !tbaa !5
...
337:                                              ; preds = %333, %333, %333, %333
  ...
  store i32 %339, i32* @pos, align 4, !tbaa !5
  %340 = icmp eq i32 %339, %2
  br i1 %340, label %341, label %333, !llvm.loop !9

341:                                              ; preds = %333, %337, %328
  %342 = tail call noundef i32 @_Z11detect_itemiPii(i32 noundef 0, i32* noundef %1, i32 noundef %2), !range !15
  %343 = icmp eq i32 %342, 0
  br i1 %343, label %578, label %344

344:                                              ; preds = %341
  %345 = load i32, i32* @pos, align 4, !tbaa !5
...
354:                                              ; preds = %349, %349, %349, %349
  ...
  store i32 %356, i32* @pos, align 4, !tbaa !5
...
364:                                              ; preds = %358, %459
  ...
  %366 = add i32 %365, 1
  store i32 %366, i32* @pos, align 4, !tbaa !5
...
375:                                              ; preds = %370, %370, %370, %370
  ...
  store i32 %377, i32* @pos, align 4, !tbaa !5
  %378 = icmp eq i32 %377, %2
  br i1 %378, label %578, label %370, !llvm.loop !9
...
389:                                              ; preds = %384, %384, %384, %384
  ...
  store i32 %391, i32* @pos, align 4, !tbaa !5
  %392 = icmp eq i32 %391, %2
  br i1 %392, label %393, label %384, !llvm.loop !9

393:                                              ; preds = %389, %384
  %394 = phi i32 [ %2, %389 ], [ %385, %384 ]
  %395 = add nsw i32 %394, 1
  store i32 %395, i32* @pos, align 4, !tbaa !5
...
403:                                              ; preds = %397, %402
  ...
  store i32 %405, i32* @pos, align 4, !tbaa !5
  %406 = icmp slt i32 %405, %2
  br i1 %406, label %397, label %578, !llvm.loop !14

407:                                              ; preds = %397
  %408 = add nsw i32 %398, 1
  store i32 %408, i32* @pos, align 4, !tbaa !5
...
417:                                              ; preds = %412, %412, %412, %412
  ...
  store i32 %419, i32* @pos, align 4, !tbaa !5
  %420 = icmp eq i32 %419, %2
  br i1 %420, label %578, label %412, !llvm.loop !9
...
429:                                              ; preds = %424
  ...
  store i32 %430, i32* @pos, align 4, !tbaa !5
...
438:                                              ; preds = %434, %434, %434, %434
  ...
  store i32 %440, i32* @pos, align 4, !tbaa !5
  %441 = icmp eq i32 %440, %2
  br i1 %441, label %442, label %434, !llvm.loop !9

442:                                              ; preds = %434, %438, %429
  %443 = tail call noundef i32 @_Z11detect_itemiPii(i32 noundef 0, i32* noundef %1, i32 noundef %2), !range !15
  %444 = icmp eq i32 %443, 0
  br i1 %444, label %578, label %445

445:                                              ; preds = %442
  %446 = load i32, i32* @pos, align 4, !tbaa !5
...
455:                                              ; preds = %450, %450, %450, %450
  ...
  store i32 %457, i32* @pos, align 4, !tbaa !5
  %458 = icmp eq i32 %457, %2
  br i1 %458, label %459, label %450, !llvm.loop !9
...
459:                                              ; preds = %450, %455, %445
  ...
  br i1 %464, label %364, label %465, !llvm.loop !17
...
475:                                              ; preds = %470, %470, %470, %470
  ...
  store i32 %477, i32* @pos, align 4, !tbaa !5
  %478 = icmp eq i32 %477, %2
  br i1 %478, label %578, label %470, !llvm.loop !9
...
576:                                              ; preds = %171, %279, %574, %547, %514, %255, %487, %147
  ...
  store i32 %577, i32* @pos, align 4, !tbaa !5
  br label %578
...
22:                                               ; preds = %18, %18, %18, %18
  ...
  store i32 %24, i32* @pos, align 4, !tbaa !5
  %25 = icmp eq i32 %13, %24
  br i1 %25, label %26, label %18, !llvm.loop !9

26:                                               ; preds = %18, %22, %12
  %27 = tail call noundef i32 @_Z11detect_itemiPii(i32 noundef 0, i32* noundef getelementptr inbounds ([50000000 x i32], [50000000 x i32]* @buffer, i64 0, i64 0), i32 noundef %13), !range !15
...
36:                                               ; preds = %32, %32, %32, %32
  ...
  store i32 %38, i32* @pos, align 4, !tbaa !5
