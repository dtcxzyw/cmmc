...
define dso_local void @_Z8add_edgeii(i32 noundef %0, i32 noundef %1) local_unnamed_addr #2 {
  ...
  store i32 %10, i32* %14, align 4, !tbaa !8
  %17 = add nsw i32 %3, 2
  store i32 %17, i32* @cnt, align 4, !tbaa !8
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable writeonly
define dso_local void @_Z4initv() local_unnamed_addr #3 {
  call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 16 dereferenceable(4020) bitcast ([1005 x i32]* @head to i8*), i8 -1, i64 4020, i1 false), !tbaa !8
  ret void
}
...
define dso_local void @_Z7inqueuei(i32 noundef %0) local_unnamed_addr #2 {
  ...
  %4 = load i32, i32* @tail, align 4, !tbaa !8
  %5 = add nsw i32 %4, 1
  store i32 %5, i32* @tail, align 4, !tbaa !8
  %6 = sext i32 %5 to i64
...
define dso_local noundef i32 @_Z9pop_queuev() local_unnamed_addr #2 {
  ...
  %2 = add nsw i32 %1, 1
  store i32 %2, i32* @h, align 4, !tbaa !8
  %3 = sext i32 %2 to i64
...
define dso_local noundef i32 @_Z4sameii(i32 noundef %0, i32 noundef %1) local_unnamed_addr #4 {
  ...
  store i32 1, i32* @tail, align 4, !tbaa !8
  store i32 %0, i32* getelementptr inbounds ([1005 x i32], [1005 x i32]* @que, i64 0, i64 1), align 4, !tbaa !8
  br label %20
...
5:                                                ; preds = %48, %20
  ...
  %7 = sext i32 %6 to i64
  %8 = icmp slt i64 %24, %7
  br i1 %8, label %20, label %9, !llvm.loop !12

9:                                                ; preds = %5
  %10 = trunc i64 %24 to i32
  store i32 %10, i32* @h, align 4, !tbaa !8
  %11 = icmp slt i32 %6, 0
...
44:                                               ; preds = %33
  ...
  %45 = add nsw i32 %36, 1
  store i32 %45, i32* @tail, align 4, !tbaa !8
  %46 = sext i32 %45 to i64
  %47 = getelementptr inbounds [1005 x i32], [1005 x i32]* @que, i64 0, i64 %46
  store i32 %39, i32* %47, align 4, !tbaa !8
  br label %48
...
48:                                               ; preds = %44, %33
  ...
  %53 = icmp eq i32 %52, -1
  br i1 %53, label %5, label %33, !llvm.loop !13
...
51:                                               ; preds = %42
  ...
  tail call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 16 dereferenceable(4020) bitcast ([1005 x i32]* @head to i8*), i8 -1, i64 4020, i1 false) #7, !tbaa !8
  %55 = icmp eq i32 %54, 0
...
60:                                               ; preds = %56, %60
  ...
  br i1 %63, label %64, label %60, !llvm.loop !17
...
74:                                               ; preds = %70, %74
  ...
  br i1 %81, label %74, label %71, !llvm.loop !5
...
82:                                               ; preds = %82, %71
  ...
  br i1 %90, label %82, label %91, !llvm.loop !7
...
101:                                              ; preds = %91, %101
  ...
  br i1 %108, label %101, label %98, !llvm.loop !5
...
109:                                              ; preds = %109, %98
  ...
  br i1 %117, label %109, label %118, !llvm.loop !7
...
118:                                              ; preds = %109
  ...
  store i32 1, i32* @tail, align 4, !tbaa !8
  store i32 %94, i32* getelementptr inbounds ([1005 x i32], [1005 x i32]* @que, i64 0, i64 1), align 4, !tbaa !8
  br label %139
...
124:                                              ; preds = %167, %139
  ...
  br i1 %127, label %139, label %128, !llvm.loop !12

128:                                              ; preds = %124
  %129 = trunc i64 %143 to i32
  store i32 %129, i32* @h, align 4, !tbaa !8
...
163:                                              ; preds = %152
  store i32 1, i32* %160, align 4, !tbaa !8
  %164 = add nsw i32 %155, 1
  store i32 %164, i32* @tail, align 4, !tbaa !8
  %165 = sext i32 %164 to i64
  %166 = getelementptr inbounds [1005 x i32], [1005 x i32]* @que, i64 0, i64 %165
  store i32 %158, i32* %166, align 4, !tbaa !8
  br label %167
...
167:                                              ; preds = %163, %152
  ...
  br i1 %172, label %124, label %152, !llvm.loop !13
...
173:                                              ; preds = %173, %137
  ...
  store i32 0, i32* %189, align 4, !tbaa !8
  %190 = or i64 %174, 3
  ...
  br i1 %197, label %198, label %173, !llvm.loop !14
...
201:                                              ; preds = %198, %201
  ...
  store i32 0, i32* %207, align 4, !tbaa !8
  %208 = add nuw nsw i64 %202, 1
  %209 = add i64 %203, 1
  %210 = icmp eq i64 %209, %135
  br i1 %210, label %211, label %201, !llvm.loop !18
...
216:                                              ; preds = %212, %216
  ...
  br i1 %223, label %216, label %213, !llvm.loop !5
...
224:                                              ; preds = %224, %213
  ...
  br i1 %232, label %224, label %233, !llvm.loop !7
...
243:                                              ; preds = %233, %243
  ...
  br i1 %250, label %243, label %240, !llvm.loop !5
...
260:                                              ; preds = %251
  ...
  store i32 %276, i32* %277, align 4, !tbaa !8
  store i32 %271, i32* %275, align 4, !tbaa !8
  %278 = add nsw i32 %264, 2
  store i32 %278, i32* @cnt, align 4, !tbaa !8
  br label %279

279:                                              ; preds = %260, %211
  %280 = load i32, i32* @m, align 4, !tbaa !8
  %281 = add nsw i32 %280, -1
  store i32 %281, i32* @m, align 4, !tbaa !8
  %282 = icmp eq i32 %281, 0
  br i1 %282, label %283, label %56, !llvm.loop !19
