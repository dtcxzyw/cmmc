...
.p2align 2
	...
	fcvt.s.w f11, a0
	fsub.s f10, f10, f11
	blt a0, zero, label502
	beq a0, zero, label552
	lui a1, 260096
pcrel588:
	auipc a2, %pcrel_hi(__cmmc_fp_constant_pool)
	fmv.w.x f13, a1
	addi a1, a2, %pcrel_lo(pcrel588)
	flw f11, 4(a1)
	fmul.s f14, f13, f11
	andi a1, a0, 1
	fmv.s f12, f14
