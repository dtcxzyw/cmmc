...
.p2align 2
	...
	sd ra, 0(sp)
	flt.s a0, f10, f11
	bne a0, zero, label498
	fcvt.w.s a0, f10, rtz
	fcvt.s.w f11, a0
	fsub.s f10, f10, f11
	blt a0, zero, label504
	beq a0, zero, label554
	lui a2, 260096
pcrel588:
	auipc a1, %pcrel_hi(__cmmc_fp_constant_pool)
	fmv.w.x f13, a2
	addi a2, a1, %pcrel_lo(pcrel588)
	flw f11, 4(a2)
.p2align 2
label511:
	fmul.s f14, f13, f11
