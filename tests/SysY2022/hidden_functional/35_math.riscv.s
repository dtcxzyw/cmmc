...
my_exp:
	...
	sd ra, 0(sp)
	flt.s a0, f10, f11
	bne a0, zero, label514
	fcvt.w.s a0, f10, rtz
	fcvt.s.w f11, a0
	fsub.s f10, f10, f11
	blt a0, zero, label503
	j label509
label501:
	jal eee
	fmul.s f10, f0, f10
...
pcrel743:
	...
	lui s0, 260096
	addi s4, a1, %pcrel_lo(pcrel743)
	beq a0, zero, label594
	mv s5, a0
	j label595
label594:
	mv a0, zero
