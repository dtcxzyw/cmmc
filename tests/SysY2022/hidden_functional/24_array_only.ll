...
22:                                               ; preds = %17, %25, %2
  ...
  %24 = add nsw i32 %23, 1
  store i32 %24, i32* %0, align 4, !tbaa !4
  ret void
...
define dso_local void @_Z3incPi(i32* nocapture noundef %0) local_unnamed_addr #1 {
  %2 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @k, i64 0, i64 0), align 4, !tbaa !4
  %3 = icmp eq i32 %2, 0
  %4 = load i32, i32* %0, align 4, !tbaa !4
...
28:                                               ; preds = %17, %22, %1
  ...
  %30 = add nsw i32 %29, 1
  store i32 %30, i32* %0, align 4, !tbaa !4
  ret void
}
...
25:                                               ; preds = %3, %23
  ...
  store i32 %28, i32* %0, align 4, !tbaa !4
  ret void
...
define dso_local void @_Z3addPiS_(i32* nocapture noundef %0, i32* nocapture noundef readonly %1) local_unnamed_addr #1 {
  %3 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @k, i64 0, i64 0), align 4, !tbaa !4
  %4 = icmp eq i32 %3, 0
  %5 = load i32, i32* %0, align 4, !tbaa !4
...
31:                                               ; preds = %2, %23
  ...
  store i32 %34, i32* %0, align 4, !tbaa !4
  ret void
}
...
define dso_local noundef i32 @main() local_unnamed_addr #2 {
  ...
  store i32 %3, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @k, i64 0, i64 0), align 4, !tbaa !4
...
8:                                                ; preds = %0
  ...
  %11 = load i32, i32* %5, align 8, !tbaa !4
  %12 = icmp slt i32 %11, 5
  br i1 %12, label %15, label %13

13:                                               ; preds = %8
  %14 = load i32, i32* %10, align 4, !tbaa !4
  store i32 %14, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @i, i64 0, i64 0), align 4, !tbaa !4
  br label %164
...
18:                                               ; preds = %15
  %19 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @k, i64 0, i64 0), align 4, !tbaa !4
  br label %105

20:                                               ; preds = %15, %99
  %21 = phi i32 [ %102, %99 ], [ %16, %15 ]
  %22 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @i, i64 0, i64 0), align 4, !tbaa !4
  call void @_Z6putinti(i32 noundef %22)
  call void @_Z6putinti(i32 noundef %21)
  call void @_Z6putinti(i32 noundef %4)
  %23 = load i32, i32* %5, align 8, !tbaa !4
  call void @_Z6putinti(i32 noundef %23)
  %24 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @k, i64 0, i64 0), align 4, !tbaa !4
  %25 = icmp eq i32 %24, 0
  %26 = load i32, i32* %5, align 8, !tbaa !4
...
31:                                               ; preds = %27, %31
  ...
  br i1 %38, label %39, label %31, !llvm.loop !15
...
57:                                               ; preds = %52, %57
  ...
  br i1 %64, label %65, label %57, !llvm.loop !16
...
80:                                               ; preds = %76, %80
  ...
  br i1 %87, label %88, label %80, !llvm.loop !17
...
99:                                               ; preds = %88, %93, %44
  ...
  store i32 %103, i32* %5, align 8, !tbaa !4
  %104 = icmp slt i32 %102, 5
  br i1 %104, label %20, label %105, !llvm.loop !18

105:                                              ; preds = %99, %18
  %106 = phi i32 [ %16, %18 ], [ %103, %99 ]
  %107 = phi i32 [ %19, %18 ], [ %24, %99 ]
  %108 = icmp eq i32 %107, 0
  %109 = load i32, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @i, i64 0, i64 0), align 4, !tbaa !4
...
114:                                              ; preds = %110, %114
  ...
  br i1 %121, label %122, label %114, !llvm.loop !20
...
140:                                              ; preds = %135, %140
  ...
  br i1 %147, label %148, label %140, !llvm.loop !21
...
159:                                              ; preds = %148, %153, %127
  ...
  store i32 %161, i32* getelementptr inbounds ([1 x i32], [1 x i32]* @i, i64 0, i64 0), align 4, !tbaa !4
  %162 = load i32, i32* %10, align 4, !tbaa !4
  %163 = icmp eq i32 %161, %162
  br i1 %163, label %164, label %15, !llvm.loop !22
