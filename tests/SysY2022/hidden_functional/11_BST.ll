...
define dso_local noundef i32 @_Z8new_nodei(i32 noundef %0) local_unnamed_addr #1 {
  %2 = load i32, i32* @now, align 4, !tbaa !5
  %3 = sext i32 %2 to i64
  ...
  %7 = add nsw i32 %2, 1
  store i32 %7, i32* @now, align 4, !tbaa !5
  ret i32 %2
}
...
4:                                                ; preds = %2
  %5 = load i32, i32* @now, align 4, !tbaa !5
  %6 = sext i32 %5 to i64
  %7 = getelementptr inbounds [10000 x i32], [10000 x i32]* @value, i64 0, i64 %6
  ...
  %10 = add nsw i32 %5, 1
  store i32 %10, i32* @now, align 4, !tbaa !5
  br label %16
...
define dso_local noundef i32 @main() local_unnamed_addr #5 {
  store i32 0, i32* @now, align 4, !tbaa !5
