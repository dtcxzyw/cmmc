...
pcrel1111:
	...
	addi s2, a2, %pcrel_lo(pcrel1108)
	addi s3, a4, %pcrel_lo(pcrel1109)
	addi s1, a3, %pcrel_lo(pcrel1110)
pcrel1112:
	auipc a2, %pcrel_hi(f)
	addi a5, a2, %pcrel_lo(pcrel1112)
	li a2, 9
	sd a5, 104(sp)
	addi a5, s7, %pcrel_lo(pcrel1111)
	sd a5, 112(sp)
	bleu a1, a2, label197
	mv s4, a0
	mv s5, zero
