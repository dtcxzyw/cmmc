...
3:                                                ; preds = %0
  ...
  call void @llvm.memset.p0i8.i64(i8* align 4 bitcast (i32* getelementptr inbounds ([1005 x i32], [1005 x i32]* @vis, i64 0, i64 1) to i8*), i8 0, i64 %5, i1 false), !tbaa !8
  br label %6
...
51:                                               ; preds = %42
  ...
  tail call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 16 dereferenceable(4020) bitcast ([1005 x i32]* @head to i8*), i8 -1, i64 4020, i1 false) #8, !tbaa !8
  %55 = icmp eq i32 %54, 0
...
118:                                              ; preds = %109
  ...
  %122 = load i32, i32* @n, align 4, !tbaa !8
...
124:                                              ; preds = %118
  ...
  tail call void @llvm.memset.p0i8.i64(i8* align 4 bitcast (i32* getelementptr inbounds ([1005 x i32], [1005 x i32]* @vis, i64 0, i64 1) to i8*), i8 0, i64 %126, i1 false) #8, !tbaa !8
  br label %127
...
133:                                              ; preds = %129, %133
  ...
  br i1 %140, label %133, label %130, !llvm.loop !5
...
141:                                              ; preds = %141, %130
  ...
  br i1 %149, label %141, label %150, !llvm.loop !7
...
160:                                              ; preds = %150, %160
  ...
  br i1 %167, label %160, label %157, !llvm.loop !5
...
177:                                              ; preds = %168
  ...
  store i32 %195, i32* @cnt, align 4, !tbaa !8
  br label %196

196:                                              ; preds = %177, %127
  %197 = load i32, i32* @m, align 4, !tbaa !8
  %198 = add nsw i32 %197, -1
  store i32 %198, i32* @m, align 4, !tbaa !8
  %199 = icmp eq i32 %198, 0
  br i1 %199, label %200, label %56, !llvm.loop !14
