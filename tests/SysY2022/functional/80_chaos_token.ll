...
define dso_local noundef i32 @main() local_unnamed_addr #2 {
  %1 = load i32, i32* getelementptr inbounds (<{ [28 x i32], [72 x i32] }>, <{ [28 x i32], [72 x i32] }>* @__HELLO, i64 0, i32 0, i64 0), align 16, !tbaa !5
  %2 = icmp eq i32 %1, 0
...
29:                                               ; preds = %22, %17
  %30 = load i32, i32* getelementptr inbounds (<{ [15 x i32], [25 x i32] }>, <{ [15 x i32], [25 x i32] }>* @saY_HeI10_To, i64 0, i32 0, i64 0), align 16, !tbaa !5
  %31 = icmp eq i32 %30, 0
...
44:                                               ; preds = %39, %44
  ...
  %50 = icmp eq i32 %49, 0
  br i1 %50, label %51, label %44, !llvm.loop !9

51:                                               ; preds = %44, %39
  %52 = load i32, i32* getelementptr inbounds ([5 x i32], [5 x i32]* @RET, i64 0, i64 0), align 16, !tbaa !5
  %53 = icmp eq i32 %52, 0
