...
define dso_local noundef i32 @_Z2f1Pi(i32* nocapture noundef writeonly %0) local_unnamed_addr #0 {
  store i32 4000, i32* getelementptr inbounds ([4096 x i32], [4096 x i32]* @a, i64 0, i64 5), align 4, !tbaa !5
  store i32 3, i32* getelementptr inbounds ([4096 x i32], [4096 x i32]* @a, i64 0, i64 4000), align 16, !tbaa !5
  store i32 7, i32* getelementptr inbounds ([4096 x i32], [4096 x i32]* @a, i64 0, i64 4095), align 4, !tbaa !5
  %2 = load i32, i32* getelementptr inbounds ([4096 x i32], [4096 x i32]* @a, i64 0, i64 2216), align 16, !tbaa !5
  %3 = add nsw i32 %2, 9
  %4 = getelementptr inbounds i32, i32* %0, i64 7
  store i32 %3, i32* %4, align 4, !tbaa !5
  %5 = load i32, i32* getelementptr inbounds ([4096 x i32], [4096 x i32]* @a, i64 0, i64 4000), align 16, !tbaa !5
  ret i32 %5
}
