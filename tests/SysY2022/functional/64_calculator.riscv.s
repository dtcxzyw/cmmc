...
pcrel620:
	...
	addi s2, a2, %pcrel_lo(pcrel620)
pcrel621:
	auipc a2, %pcrel_hi(ints)
	addi s1, a2, %pcrel_lo(pcrel621)
pcrel622:
	auipc a2, %pcrel_hi(get2)
	addi s0, a2, %pcrel_lo(pcrel622)
