...
pcrel787:
	...
	addi t1, a3, %pcrel_lo(pcrel786)
	addi s5, a2, %pcrel_lo(pcrel787)
	sd t1, 104(sp)
pcrel788:
	auipc a2, %pcrel_hi(get2)
	addi s1, a2, %pcrel_lo(pcrel788)
...
label61:
	...
	or t6, t3, t2
	or t4, t1, t6
	beq t4, zero, label286
	sh2add t1, a4, s1
	addiw a5, a5, -1
	addiw a4, a4, 2
	sw s0, 0(t1)
	sw t0, 4(t1)
	bne a5, zero, label298
	mv a3, a4
	addi a1, a1, 4
	mv t0, a4
	addiw a4, a5, 1
