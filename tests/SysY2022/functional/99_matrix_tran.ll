...
define dso_local noundef i32 @_Z4tranPfS_S_S_S_S_S_S_S_(float* nocapture noundef readonly %0, float* nocapture noundef readonly %1, float* nocapture noundef readonly %2, float* nocapture readnone %3, float* nocapture readnone %4, float* nocapture readnone %5, float* nocapture noundef writeonly %6, float* nocapture noundef writeonly %7, float* nocapture noundef writeonly %8) local_unnamed_addr #0 {
  ...
  %11 = load float, float* %10, align 4, !tbaa !4
  %12 = getelementptr inbounds float, float* %7, i64 2
  store float %11, float* %12, align 4, !tbaa !4
  ...
  store float %14, float* %15, align 4, !tbaa !4
  %16 = load float, float* %1, align 4, !tbaa !4
  %17 = getelementptr inbounds float, float* %6, i64 1
  store float %16, float* %17, align 4, !tbaa !4
  %18 = load float, float* %2, align 4, !tbaa !4
  %19 = getelementptr inbounds float, float* %6, i64 2
  store float %18, float* %19, align 4, !tbaa !4
  %20 = getelementptr inbounds float, float* %0, i64 1
  %21 = load float, float* %20, align 4, !tbaa !4
  store float %21, float* %7, align 4, !tbaa !4
  %22 = getelementptr inbounds float, float* %0, i64 2
  %23 = load float, float* %22, align 4, !tbaa !4
  store float %23, float* %8, align 4, !tbaa !4
  ...
  store float %25, float* %26, align 4, !tbaa !4
  ...
  store float %28, float* %29, align 4, !tbaa !4
  %30 = load float, float* %0, align 4, !tbaa !4
  store float %30, float* %6, align 4, !tbaa !4
  ret i32 0
}
...
define dso_local noundef i32 @main() local_unnamed_addr #2 {
  ...
  store float 1.000000e+00, float* %10, align 4, !tbaa !4
  %11 = getelementptr inbounds [3 x float], [3 x float]* %3, i64 0, i64 1
  store float 2.000000e+00, float* %11, align 4, !tbaa !4
  %12 = getelementptr inbounds [6 x float], [6 x float]* %1, i64 0, i64 1
  store float 0.000000e+00, float* %12, align 4, !tbaa !4
  %13 = getelementptr inbounds [6 x float], [6 x float]* %1, i64 0, i64 2
  store float 0.000000e+00, float* %13, align 8, !tbaa !4
  store float 1.000000e+00, float* %8, align 4, !tbaa !4
  store float 2.000000e+00, float* %9, align 4, !tbaa !4
  %14 = getelementptr inbounds [3 x float], [3 x float]* %2, i64 0, i64 1
  store float 1.000000e+00, float* %14, align 4, !tbaa !4
  %15 = getelementptr inbounds [3 x float], [3 x float]* %3, i64 0, i64 2
  store float 2.000000e+00, float* %15, align 4, !tbaa !4
