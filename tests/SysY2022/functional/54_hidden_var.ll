...
define dso_local noundef i32 @main() local_unnamed_addr #0 {
  ...
  tail call void @_Z6putinti(i32 noundef 1)
  tail call void @_Z5putchi(i32 noundef 10)
  store i32 1, i32* getelementptr inbounds ([4 x i32], [4 x i32]* @c, i64 0, i64 2), align 8, !tbaa !5
  ...
  tail call void @_Z6putinti(i32 noundef %1)
  tail call void @_Z5putchi(i32 noundef 10)
  %2 = load i32, i32* getelementptr inbounds ([4 x i32], [4 x i32]* @c, i64 0, i64 0), align 16, !tbaa !5
  tail call void @_Z6putinti(i32 noundef %2)
  %3 = load i32, i32* getelementptr inbounds ([4 x i32], [4 x i32]* @c, i64 0, i64 1), align 4, !tbaa !5
  tail call void @_Z6putinti(i32 noundef %3)
  %4 = load i32, i32* getelementptr inbounds ([4 x i32], [4 x i32]* @c, i64 0, i64 2), align 8, !tbaa !5
  tail call void @_Z6putinti(i32 noundef %4)
  %5 = load i32, i32* getelementptr inbounds ([4 x i32], [4 x i32]* @c, i64 0, i64 3), align 4, !tbaa !5
