...
14:                                               ; preds = %12, %14
  ...
  br i1 %35, label %36, label %14, !llvm.loop !11
...
define dso_local noundef i32 @main() local_unnamed_addr #2 {
  ...
  store float 0.000000e+00, float* %7, align 16, !tbaa !9
  %8 = getelementptr inbounds [3 x float], [3 x float]* %2, i64 0, i64 0
  store float 0.000000e+00, float* %8, align 4, !tbaa !9
  ...
  store float 2.000000e+00, float* %10, align 4, !tbaa !9
  ...
  store float 4.000000e+00, float* %13, align 8, !tbaa !9
  %14 = getelementptr inbounds [3 x float], [3 x float]* %2, i64 0, i64 2
  store float 4.000000e+00, float* %14, align 4, !tbaa !9
  %15 = getelementptr inbounds [3 x float], [3 x float]* %3, i64 0, i64 2
  store float 4.000000e+00, float* %15, align 4, !tbaa !9
  tail call void @_Z6putinti(i32 noundef 0)
  %16 = load i32, i32* @N, align 4, !tbaa !5
  %17 = icmp sgt i32 %16, 1
  br i1 %17, label %18, label %27, !llvm.loop !13
...
30:                                               ; preds = %27
  ...
  br i1 %32, label %33, label %42, !llvm.loop !14
...
45:                                               ; preds = %42
  ...
  br i1 %47, label %48, label %57, !llvm.loop !15
