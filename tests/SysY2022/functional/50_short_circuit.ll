...
3:                                                ; preds = %0
  %4 = load i32, i32* @g, align 4, !tbaa !4
  %5 = add nsw i32 %4, %1
  store i32 %5, i32* @g, align 4, !tbaa !4
...
9:                                                ; preds = %6
  %10 = load i32, i32* @g, align 4, !tbaa !4
  %11 = add nsw i32 %10, %7
  store i32 %11, i32* @g, align 4, !tbaa !4
...
15:                                               ; preds = %12
  %16 = load i32, i32* @g, align 4, !tbaa !4
  %17 = add nsw i32 %16, %13
  store i32 %17, i32* @g, align 4, !tbaa !4
...
21:                                               ; preds = %18
  %22 = load i32, i32* @g, align 4, !tbaa !4
  %23 = add nsw i32 %22, %19
  store i32 %23, i32* @g, align 4, !tbaa !4
  tail call void @_Z6putinti(i32 noundef %23)
  br label %24

24:                                               ; preds = %21, %18
  %25 = load i32, i32* @g, align 4, !tbaa !4
  %26 = add nsw i32 %25, 99
  store i32 %26, i32* @g, align 4, !tbaa !4
  tail call void @_Z6putinti(i32 noundef %26)
  %27 = load i32, i32* @g, align 4, !tbaa !4
  %28 = icmp eq i32 %27, 0
  br i1 %28, label %29, label %30

29:                                               ; preds = %24
  store i32 100, i32* @g, align 4, !tbaa !4
