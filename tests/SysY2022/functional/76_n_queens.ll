...
define dso_local void @_Z8printansv() local_unnamed_addr #0 {
  ...
  %2 = add nsw i32 %1, 1
  store i32 %2, i32* @sum, align 4, !tbaa !4
...
13:                                               ; preds = %5
  ...
  br i1 %17, label %5, label %18, !llvm.loop !8
...
29:                                               ; preds = %22
  store i32 %13, i32* %6, align 4, !tbaa !4
  %30 = icmp eq i32 %10, %0
  br i1 %30, label %31, label %48

31:                                               ; preds = %29
  %32 = load i32, i32* @sum, align 4, !tbaa !4
  %33 = add nsw i32 %32, 1
  store i32 %33, i32* @sum, align 4, !tbaa !4
...
41:                                               ; preds = %34
  tail call void @_Z5putchi(i32 noundef 10)
  %42 = load i32, i32* @n, align 4, !tbaa !4
  br label %48
...
48:                                               ; preds = %43, %41, %31, %29
  ...
  store i32 0, i32* %56, align 4, !tbaa !4
  br label %57
...
57:                                               ; preds = %48, %22, %17, %9
  ...
  br i1 %62, label %9, label %63, !llvm.loop !10
...
3:                                                ; preds = %0, %3
  ...
  store i32 %5, i32* @n, align 4, !tbaa !4
  tail call void @_Z1fi(i32 noundef 1)
  %6 = add nsw i32 %4, -1
  %7 = icmp ugt i32 %4, 1
  br i1 %7, label %3, label %8, !llvm.loop !11

8:                                                ; preds = %3, %0
  %9 = load i32, i32* @sum, align 4, !tbaa !4
  ret i32 %9
}
