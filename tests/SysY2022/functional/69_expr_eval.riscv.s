...
pcrel825:
	...
	addi s4, s2, %pcrel_lo(pcrel824)
	addi s1, s0, %pcrel_lo(pcrel825)
.p2align 2
label2:
	jal getch
	xori a4, a0, 10
...
pcrel831:
	auipc s2, %pcrel_hi(ops)
	sw t0, %pcrel_lo(pcrel831)(s2)
pcrel832:
	auipc s0, %pcrel_hi(oprs)
	lw a5, %pcrel_lo(pcrel832)(s0)
	addi t2, a5, -2
	addi t3, a5, -1
	sh2add t1, a5, s1
	lw a4, 0(t1)
	sw t3, %pcrel_lo(pcrel832)(s0)
	lw t0, -4(t1)
	sw t2, %pcrel_lo(pcrel832)(s0)
	beq a3, s5, label79
	bne a3, s6, label769
	subw a3, t0, a4
	lw a5, %pcrel_lo(pcrel832)(s0)
...
pcrel835:
	auipc s0, %pcrel_hi(oprs)
	lw a5, %pcrel_lo(pcrel835)(s0)
	addiw a4, a5, 1
	sh2add t0, a4, s1
	sw a4, %pcrel_lo(pcrel835)(s0)
	sw a3, 0(t0)
pcrel836:
	auipc s2, %pcrel_hi(ops)
	lw a4, %pcrel_lo(pcrel836)(s2)
	bne a4, zero, label75
.p2align 2
label74:
	auipc s0, %pcrel_hi(oprs)
...
pcrel838:
	auipc s2, %pcrel_hi(ops)
	sw t0, %pcrel_lo(pcrel838)(s2)
pcrel839:
	auipc s0, %pcrel_hi(oprs)
	lw a5, %pcrel_lo(pcrel839)(s0)
	addi t2, a5, -2
	addi t3, a5, -1
	sh2add t1, a5, s1
	lw a4, 0(t1)
	sw t3, %pcrel_lo(pcrel839)(s0)
	lw t0, -4(t1)
	sw t2, %pcrel_lo(pcrel839)(s0)
	beq a3, s5, label50
	beq a3, s6, label54
	li a5, 42
	bne a3, a5, label56
...
pcrel840:
	auipc s2, %pcrel_hi(ops)
	lw a4, %pcrel_lo(pcrel840)(s2)
	sh2add a5, a4, s4
	bne a4, zero, label47
	addiw a3, a4, 1
	sw a3, %pcrel_lo(pcrel840)(s2)
	sw s10, 4(a5)
label347:
	mv s9, a1
	j label25
...
pcrel842:
	auipc s0, %pcrel_hi(oprs)
	lw t0, %pcrel_lo(pcrel842)(s0)
	addiw a3, t0, 1
	sh2add a5, a3, s1
	sw a3, %pcrel_lo(pcrel842)(s0)
	sw a4, 0(a5)
pcrel843:
	auipc s2, %pcrel_hi(ops)
...
pcrel846:
	auipc s0, %pcrel_hi(oprs)
	lw a5, %pcrel_lo(pcrel846)(s0)
	addiw a4, a5, 1
	sh2add t0, a4, s1
	sw a4, %pcrel_lo(pcrel846)(s0)
	sw zero, 0(t0)
pcrel847:
	auipc s2, %pcrel_hi(ops)
	lw a4, %pcrel_lo(pcrel847)(s2)
	bne a4, zero, label75
	j label74
label325:
	mv s9, a1
