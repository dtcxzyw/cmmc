...
pcrel522:
	...
	addi a1, a0, %pcrel_lo(pcrel522)
	flw f11, 0(a1)
	flw f12, 0(a1)
	fle.s a2, f12, f10
	fsw f10, 4(sp)
	bne a2, zero, label503
pcrel523:
	auipc a0, %pcrel_hi(__cmmc_fp_constant_pool)
	addi a1, a0, %pcrel_lo(pcrel523)
	flw f10, 4(a1)
	flw f11, 4(sp)
	fadd.s f12, f11, f10
	fmv.s f13, f12
